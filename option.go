...
// WithTraceIDField configures the logger to add `TraceId` field to structured log messages.
//
...
// WithSpanIDField configures the logger to add `SpanID` field to structured log messages.
//
// This option is only useful with backends that don't support OTLP and instead parse log
// messages to extract structured information.
